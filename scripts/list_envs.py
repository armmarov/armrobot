...
All the environments are registered in the `ArmRobotLegging` extension. They start
...
import ArmRobotLegging.tasks  # noqa: F401


def main():
    """Print all environments registered in `ArmRobotLegging` extension."""
